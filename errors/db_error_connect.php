	...
	<div id="wrapper">
		...
		<div id="container">
			<div id="centerContentSingle">
				<h1>Uh Oh...</h1>
			    <p>We had a little issue while trying to connect to the database.</p>
			    <p>Sorry about that.</p>
			    <p>Hit the back button and give it another try.</p>
			    <p>If the error happens again, please contact <br> Mystic Rhythms Customer Support @ 1-800-PLAY GTR for assistance.</p>
